...
{
     QMessageBox::information(this,"hanshul 212218205015", "This is QMessageBox");
}

void Dialog::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply = QMessageBox::question(this,
                                       "hanshul 212218205015", "Do You like strawberry?",
...
{
    QMessageBox::StandardButton reply = QMessageBox::question(this,
                                       "hanshul 212218205015", "This is Custom message",
        ...
        {
            QMessageBox::warning(this,"hanshul 212218205015","Display the message with warning as YesToAll");
        }
        if(reply == QMessageBox::NoToAll)
        {
            QMessageBox::warning(this,"hanshul 212218205015","Don't display the message with warning as YesToAll");
        }
        if(reply == QMessageBox::No) {
...
{
    QMessageBox::warning(this,"hanshul 212218205015", "this is warning message");
